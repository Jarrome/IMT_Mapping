...
def main():
    ...
    model = net_module.Model(args.code_length*3*2, **args.network_specs).cuda()
    ...
    all_lat_vecs = torch.zeros((len(lif_dataset), args.code_length*3*2)).cuda()
    ...
    for epoch in epoch_bar:
        ...
        for sdf_data, surface_data, idx in lif_loader:
            ...
            all_lat_vecs[idx] = lat_vecs.detach()        # Just for recording, no other usages.
